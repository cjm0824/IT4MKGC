    ...
    for line in tqdm(questions):
        ...
        with torch.inference_mode():
            output_ids = model.generate(#生成模型的输出
                ...
                repetition_penalty=1.8,#惩罚重复答案
                # diversity_penalty=1.2,#强化多样性
...
def eval_score(args):
    ...
    hit_at_1, hit_at_3, hit_at_10, rank_sum, mrr_sum = 0, 0, 0, 0, 0
    ...
    mrr_score = mrr_sum / total_samples  # MRR 计算
    ...
    print(f"Mean Reciprocal Rank (MRR): {mrr_score:.4f}")  # 输出 MRR
...
if __name__ == "__main__":
    ...
    parser.add_argument("--answers-file", type=str, default="../../verbalizer/wn18-verbalizer_update/test_answer-3.json")
